...
Future<Uint8List> generateInvoice(PdfPageFormat pageFormat) async {
  ...
  int i=1;
 saleItemPdf.saleItem.billedItem.forEach((element)  {
    [
    products.add(Product(i.toString(),element.productName(saleItemPdf.productItem), element.rate, element.qty)),
    ];
    i=i+1;}
    );
 ...
 //final products = Product;
  ...
  final invoice = Invoice(
    invoiceNumber: saleItemPdf.invoiceNumber,
    products: products,
    customerName: saleItemPdf.partyName,
    customerAddress: '${saleItemPdf.partyAddress}\n${saleItemPdf.partyPhoneNumber}',
    paymentInfo:
        saleItemPdf.paymentInfo,
    tax: saleItemPdf.saleItem.tax,
    discount: saleItemPdf.saleItem.discount,
    recieved: saleItemPdf.saleItem.recieved,
...
class Invoice {
  ...
  double get _grandTotal => (_total-(_total*(discount/100))) * (1 + tax);
  double get _balance => _grandTotal - recieved;
  ...
  Future<Uint8List> buildPdf(PdfPageFormat pageFormat) async {
    ...
    final font2 = await rootBundle.load('assets/roboto.bold.ttf');
    final font3 = await rootBundle.load('assets/roboto.italic.ttf');
      ...
      children: [
        pw.Container(
          ...
          child: pw.BarcodeWidget(
            ...
            data: '${Txt.invoiceNumber} $invoiceNumber',
          ),
        ),
        pw.Text(
          '${Txt.page} ${context.pageNumber}/${context.pagesCount}',
      ...
      children: [
        pw.Expanded(
          child: pw.Container(
            ...
            child: pw.FittedBox(
              child: pw.Text(
                '${Txt.total} ${_formatCurrency(_grandTotal)}',
                style: pw.TextStyle(
                  color: baseColor,
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text('${Txt.discount} :'),
                    pw.Text('${(discount).toStringAsFixed(1)}%'),
                  ],
                ),
                ...
                pw.DefaultTextStyle(
                  ...
                  child: pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [
                      pw.Text('${Txt.recieved} :'),
                      pw.Text(_formatCurrency(recieved)),
                    ],
                  ),
                ),
                pw.DefaultTextStyle(
                  ...
                  child: pw.Row(
                    ...
                    children: [
                      pw.Text('${Txt.balance} :'),
                      pw.Text(_formatCurrency(_balance)),
                    ],
                  ),
                ),
              ],
